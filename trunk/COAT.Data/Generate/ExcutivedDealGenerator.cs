...
namespace COAT.Data.Generate
{
    public class ExcutivedDealGenerator : BaseGenerator<ExcutivedDeal>
    {
                ...
                return new[]
                           {
                               ...
                               new ColunmPropertyPair<ExcutivedDeal>("End User Company(Local)", a => a.EndUserName2,
                                                                     true),
        ...
        protected override ExcutivedDeal GetInstance(DataRow row)
        {
        ...
        {
            ExcutivedDeal edeal = Entity.ExcutivedDeals.FirstOrDefault(a => a.DealId == obj.DealId);

            if (edeal != null)
            {
                edeal.Update(obj, new[] {"DealId"});
                Entity.SaveChanges();
                return edeal;
            }
